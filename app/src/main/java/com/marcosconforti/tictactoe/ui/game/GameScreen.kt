package com.marcosconforti.tictactoe.ui.game
...
import com.marcosconforti.tictactoe.ui.theme.Accent
import com.marcosconforti.tictactoe.ui.theme.Background
import com.marcosconforti.tictactoe.ui.theme.BlueLink
import com.marcosconforti.tictactoe.ui.theme.Orange1
import com.marcosconforti.tictactoe.ui.theme.Orange2
...
fun GameScreen(
    ...
    if (winner != null) {
        Box(modifier = Modifier
            .fillMaxSize()
            .background(Background), contentAlignment = Alignment.Center, content = {})
        Card(
            modifier = Modifier
                .fillMaxWidth()
                .wrapContentHeight()
            ...
            Column(
                ...
                Text(text = "FELICIDADES", fontSize = 22.sp, color = Accent)
    ...
    Column(
        ...
        Text(text = game.gameId, color = BlueLink, modifier = Modifier
            ...
            .clickable {
                ...
                Toast
                    .makeText(context, "se ha copiado con exito", Toast.LENGTH_SHORT)
                    .show()
            })
...
fun GameItem(playerType: PlayerType, onItemSelected: () -> Unit) {
    Box(
        modifier = Modifier
            .padding(12.dp)
            .size(64.dp)
            .border(border = BorderStroke(2.dp, Accent))
